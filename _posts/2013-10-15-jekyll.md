...
A nice trick is to create the .gitignore file, in the staticsite directory, and to add "<sub>site</sub>" to it. This would force Git to ignore the \_site directory. This is useful because there is no need to transmit that directory from a computer to another.
